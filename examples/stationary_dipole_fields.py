...
# with distinct positive and negative regions near each charge. The potential
# decays as :math:`1/r^2` along the dipole axis.
...
# ---------------
#
# The electric field :math:`\mathbf{E} = -\nabla \phi` can be decomposed into
# x, y, and z components. For a dipole oriented along y, the y-component
# dominates near the axis, while the x-component is strongest perpendicular to it.
...
# %%
# With zero magnetic field everywhere, the magnitude plot shows no field lines.
