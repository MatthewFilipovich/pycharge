...
collection of :class:`~pycharge.Charge` objects and returns a vectorized, JIT-ready evaluator
...
With our :class:`~pycharge.Charge` defined, we next construct a callable that computes the
...
2. Configure time steps and run :func:`~pycharge.simulate`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
