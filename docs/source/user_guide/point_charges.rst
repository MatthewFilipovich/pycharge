...
In PyCharge, all sources of fields are defined by their constituent charges. A ``Charge`` object encapsulates the physical properties of a point charge, most importantly its trajectory.
